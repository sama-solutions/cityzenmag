  ...
  indexContent(
    ...
    interviews.forEach(interview => {
      const result: SearchResult = {
        ...
        content: interview.keyPoints?.join(' '),
        date: interview.date,
        theme: interview.category,
        location: interview.location,
        author: interview.expert.name,
        image: interview.expert.avatar,
    ...
    reportages.forEach(reportage => {
      const result: SearchResult = {
        ...
        content: reportage.story,
        date: reportage.date,
        theme: reportage.category,
        location: reportage.location,
    ...
    videos.forEach(video => {
      const result: SearchResult = {
        ...
        content: video.chapters?.map(c => c.title).join(' '),
        date: video.date,
        theme: video.category,
        author: video.speakers?.map(s => s.name).join(', '),
